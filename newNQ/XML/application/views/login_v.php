...
<div id="system_title">
<span style="display: block; font-weight: bold; font-size: 13px; margin:2px;">Ministry of Medical Services</span>
 <span style="display: block; font-size: 11px;">National Quality Control Laboratory</span> 
</div>
...
<form action="<?php echo base_url().'user_management/submit'?>" method="post" >
