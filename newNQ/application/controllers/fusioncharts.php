...
$pie_chart['pie_charts'] = Fusioncharts(base_url() . "Scripts/FusionCharts/Bar2D.swf", $strDataURL, "", "PIE_POLL_RESULTS", 1000, 800, false, false,false);
	...
	public function ViewResults() {
		...
		if ($first_results) {
			...
			foreach ($first_results as $first_result) {
				...
				$second_query = $this -> db -> query("select acre as Tally from farm where acre >= '10000' and id='".$first_result['id']."'");
