...
<?php echo form_open('/index.php/weeding/save'); ?>
     ...
     <form id="harris">
            ...
            <fieldset class13>
                ...
                <div class="class12">
                    ...
                    <p><label for="res1">Resource 1 :</label>
                        <input type="text" name="res1" id="res1"/></p>
                        <p><label for="qnty1">Quantity 1 :</label>
                        <input type="text" name="qnty1" id="qnty1"/></p>
                        <p><label for="res2">Resource 2  :</label>
                        <input type="text" name="res2" id="qnty2"/></p>
                        <p><label for="qnty2">Quantity 2 :</label>
                        <input type="text" name="qnty2" id="qnty2"/></p>
                </div>
            </fieldset>
            <fieldset class13>
