...
<aside>
 <div class="widget" id="widget">
   ...
   <div>
    ...
    <h2><?php echo anchor('vehicles', 'Repair and Maintenance'); ?></h2>
		<h2><?php echo anchor('vehicles/performance','Vehilce Performance '); ?></h2>
    
		<h2><?php echo anchor('vehicles/get_All','View  Registered Vehicles'); ?></h2>
