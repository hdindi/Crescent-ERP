 ...
 <div class="widget" id="widget">
   ...
   <div>
    ...
    <h2><?php echo anchor('farming', 'Farming'); ?></h2>
		<h2><?php echo anchor('farming/landregistration','Land Registration'); ?></h2>
    <h2><?php echo  anchor('farming/harvesting', 'Harvesting'); ?></h2>
		<h2><?php echo anchor('farming/weeding','Weeding'); ?></h2>
