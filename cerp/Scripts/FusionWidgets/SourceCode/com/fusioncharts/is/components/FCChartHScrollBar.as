...
//Class
class com.fusioncharts.is.components.FCChartHScrollBar extends MovieClip implements com.fusioncharts.is.components.IComponent {
	...
	*/
	private function setEvents():Void {
		...
		this.faceMC.onPress = function() {
			...
			classRef.faceClickMC.onMouseMove = function() {
		...
		this.faceMC.onRelease = this.faceMC.onReleaseOutside=function () {
			...
			//Delete enterFrame
			delete classRef.faceClickMC.onMouseMove;
			//Show the face back
			this._alpha = 100;
