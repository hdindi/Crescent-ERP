...
<div class="clear"></div>
 ...
 <fieldset class="overall"> 
   <fieldset class="weight">
    ...
    <ul>
        <label>REPORTS OF COMPANY ACTIVITIES</label>
        <li><?php echo anchor('dailycharts',' Tonnage Delivered per 15 Day Period '); ?></li>
        <li><?php echo anchor('fleetrepairschart','  Fleet Repairs Cost per Month '); ?></li>
        <li><?php echo anchor('transportchart',' Vehicle Tonnage Delivery per Month '); ?></li>
