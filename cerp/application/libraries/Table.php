...
class CI_Table {
	...
	function _default_template()
	{
		return  array (
						...
						'row_start'				=> '<tr class="normal_row">',
						'row_end'				=> '</tr>',
						'cell_start'			=> '<td>',
						'cell_end'				=> '</td>',

						'row_alt_start'		=> '<tr class="alternate_row">',
						'row_alt_end'			=> '</tr>',
						'cell_alt_start'		=> '<td>',
						'cell_alt_end'			=> '</td>',
 ...
 //Function that appends a row id to each row
	function _add_row_id($name,$row_id){
					$test = $this->template['row_'.$name.'start'];
					$new_class = "_row table_row";
					$replace = " row_id = '".$row_id."'>";
					//First, add the row id to the row
					$new_row = str_replace('>', $replace, $test);
					//Then append a new class to the existing classes
					$new_row2 = str_replace('_row', $new_class, $new_row); 
					return $new_row2;
				}
